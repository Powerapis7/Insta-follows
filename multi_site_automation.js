...
const sitesConfig = [
    {
        ...
        selectors: {
            ...
            startButton: "button",
            credit: "a[href=\"/tools/send-follower\"] span.badge"
        },
...
class MultiSiteAutomation {
    ...
    async processSite(siteConfig, targetUsername, followerCount) {
        try {
            ...
            let initialCredits = await this.getFollowerCredits(siteConfig);
            if (initialCredits === 0) {
            ...
            let finalCredits = await this.getFollowerCredits(siteConfig);
            ...
            if (finalCredits < initialCredits) {
                ...
                console.log(`[${siteConfig.name}] ⚠️ Não foi possível confirmar o envio. Créditos permaneceram em ${finalCredits}.`);
            }
